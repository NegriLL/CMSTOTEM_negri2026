...
def main():
    root_path_resonant = Path(__file__).parent.parent / "data" / "exrec_resonant.root"
    root_path_nonreson = Path(__file__).parent.parent / "data" / "exrec.root"
    save_path = Path(__file__).parent.parent / "plots" / "kinematics_resonant"
